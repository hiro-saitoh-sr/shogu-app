...
- `shogu/masters`: 処遇改善加算対象の顧問先マスタ
- `shogu/deliveries/*`: 計画書・実績報告書等の提出管理データ
...
- 仕様、料金、帳票項目、本番公開、デプロイ設定、データ構造、既存データ、データ移行・削除、Firebase Rules・Authentication・権限を変更する場合は、影響範囲と確認・復旧方法を提示し、利用者の明確な承認を得てから実施する。
